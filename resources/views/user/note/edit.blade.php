            ...
            <div class="-m-2">
                <div class="p-4 w-full mx-auto">
                    <div class="form-group">
                        ...
                        <div class="col-md-12">        
                            <textarea name="editor1">{{ $note->note_content }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex-container m-4">
                <div class="image-input">
                    ...
                    <div class="image-preview mt-2" id="preview_image">
                        <img src="{{ $note->note_image }}" alt="Image preview" style="width: 200px; height: auto;">
                    </div>
                </div>
            </div>
