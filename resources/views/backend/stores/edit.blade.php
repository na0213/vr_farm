            ...
            <form action="{{ route('admin.backend.stores.update', ['id' => $store->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="-m-2">
                    <div class="p-2 w-4/5 mx-auto">
                        ...
                        <input type="text" id="product_name" name="product_name" value="{{ $store->product_name }}" required class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-yellow-500 focus:bg-white focus:ring-2 focus:ring-yellow-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                        </div>
                    </div>
                </div>
                ...
                <div class="-m-2">
                    <div class="p-2 w-4/5 mx-auto">
                        ...
                        <textarea name="product_info" id="product_info" cols="30" rows="10" required class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-yellow-500 focus:bg-white focus:ring-2 focus:ring-yellow-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">{{ trim($store->product_info) }}</textarea>
                    </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex-container m-4">
                    <div class="image-input">
                        ...
                        <div class="image-preview mt-2" id="preview_image">
                            <img src="{{ $store->product_image }}" alt="Image preview" style="width: 200px; height: auto;">
                        </div>
                    </div>
                </div>
