            ...
            <form action="{{ route('admin.backend.stores.store', ['farm' => $farm->id]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="m-2">
                    <div class="p-2 w-4/5 mx-auto">
                        ...
                        <input type="text" id="product_link" name="product_link" value="{{ old('product_link')}}" required class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-yellow-500 focus:bg-white focus:ring-2 focus:ring-yellow-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                        </div>
                    </div>
                </div>
