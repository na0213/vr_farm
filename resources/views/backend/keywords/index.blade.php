<x-admin-layout>
    ...
    <a href="{{ route('admin.backend.keywords.create') }}">
        <div class="py-12">
          ...
          <tbody>
            @forelse ($keywords as $keyword)
              <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                  ...
                  <td scope="row" class="px-6 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                      <a href="{{ route('admin.backend.keywords.edit', $keyword->id) }}" class="px-3 py-2 text-black bg-detail text-md hover:bg-yellow-500">編集</a>
                  </td>
              </tr>
              @empty
