        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="p-2 w-2/2">
                <div class="flex">
                  ...
                  <div class="w-3/5 bg-gray-100 pl-3 pt-2">{{ $keyword->keyword }}</div>
                </div>
            </div>
            <form action="{{ route('admin.backend.keywords.update', $keyword->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="p-2 w-2/2">
                    <div class="flex">
            ...
            <div class="p-2 w-full flex justify-around mt-4">
                <form action="{{ route('admin.backend.keywords.destroy', $keyword->id) }}" method="POST">
                  @csrf
                  @method('DELETE')
