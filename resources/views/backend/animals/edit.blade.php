<x-admin-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form action="{{ route('admin.backend.animals.update', ['id' => $animal->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                @if ($errors->any())
                ...
                <div class="flex-container m-10">
                    <div class="image-input">
                        ...
                        <div class="image-preview mt-2" id="preview_image">
                            <img src="{{ $animal->animal_image }}" alt="Image preview" style="width: 200px; height: auto;">
                        </div>
                    </div>
                </div>
