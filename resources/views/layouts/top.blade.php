      ...
      <div class="flex flex-col items-center space-y-4 md:flex-row md:justify-center md:space-y-0 md:space-x-6">
          ...
          {{-- <div class="flex space-x-4">
              ...
              <a href="#" aria-label="Note">
                  <!-- Noteアイコン -->
                  <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      <path d="M4.5 2A2.5 2.5 0 002 4.5v15A2.5 2.5 0 004.5 22h15a2.5 2.5 0 002.5-2.5v-15A2.5 2.5 0 0019.5 2h-15zM6 4.75h11.25c.138 0 .25.112.25.25v7.732a2.54 2.54 0 01-2.54 2.54h-5.61a2.54 2.54 0 00-2.54 2.54v1.84a.25.25 0 01-.25.25H6.25a.25.25 0 01-.25-.25v-15c0-.138.112-.25.25-.25zM9 8a1 1 0 000 2h2.5a1 1 0 000-2H9z"/>
                  </svg>
              </a>
          </div> --}}
      {{-- </div>
